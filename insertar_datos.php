...
$sql = "INSERT INTO `admision`( `id`,`cedula`, `pasaporte`, `nombre`, `primer_apellido`, `segundo_apellido`, `nacionalidad`, `sexo`, `estado_civil`, `fecha_de_nacimiento`, `tipo_de_sangre`, `religion`, `carrera_a_estudiar`, `nivel_a_estudiar`, `fecha_de_termino_de_estudios_secundarios`, `direccion`, `provincia`, `telefono_residencial`, `telefono_celular`, `correo_electronico`, `nombre_del_padre`, `apellidos_del_padre`, `telefono_del_padre`, `nombre_de_la_madre`, `apellidos_madre`, `celular_madre`,`estado`,`comentario`,`fecha_solicitud` ) VALUES ('$id','$cedula','$pasaporte','$nombre','$primer_apellido','$segundo_apellido','$nacionalidad','$sexo','$estado_civil','$fecha_de_nacimiento','$tipo_de_sangre','$religion','$carrera_a_estudiar','$fecha_de_termino_de_estudios_secundarios','$direccion','$provincia','$telefono_residencial','$telefono_celular','$telefono_celular','$correo_electronico','$nombre_del_padre','$apellidos_del_padre','$telefono_del_padre','$nombre_de_la_madre','$apellidos_madre','$celular_madre','$estado','$comentario', CURRENT_TIMESTAMP)";
